...
function Header() {
 ...
 <div class="headerPosition sticky" id="myHeader">
        ...
        <div  class="logoPosition mobileLogo"> 
            <div href="#video" class="logoM"> <img src='../images/aqualife-logo.png' class="headerLogo" alt="logo" /> </div>
            </div>
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav >
            ...
            <div  class="logoPosition d-none d-md-block"> 
